...
export function Header({ onLogin, onSignup, showAuth = true, balance, userType, onUserTypeChange, onProfileClick }: HeaderProps) {
  return (
      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          {userType && (
            <Badge 
              variant="outline" 
              className={`${userType === "master" ? "border-red-700/50 text-red-300" : "border-blue-700/50 text-blue-300"} cursor-pointer hover:opacity-75`}
